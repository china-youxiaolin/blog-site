import type { INavData } from '../../../.vitepress/theme/components/type'
...
export const NAV_DATA: INavData[] = [
  ...
  },
  {
    ...
    items: [
      {
        icon: 'http://echarts.zhangmuchen.top/favicon.ico',
        title: 'MCChart',
        desc: 'MCChart',
        link: 'http://echarts.zhangmuchen.top/#/index'
      },
      {
      ...
      },
      {
        ...
        title: 'echarts 国内镜像',
        desc: 'echarts 国内镜像社区',
        link: 'https://www.isqqw.com/echarts-doc/zh/option.html#title'
      },
      {
