...
![下载安装 HbuilderX 编辑器](images/uniapp_picture_1.png)

**2.通过 HbuilderX 创建 uni-app vue3 项目**

![通过 HbuilderX 创建 uni-app vue3 项目](images/uniapp_picture_2.png)

**3.安装 uni-app vue3 编译器插件**

![安装 uni-app vue3 编译器插件](images/uniapp_picture_3.png)

**4.编译成微信小程序端代码**

![编译成微信小程序端代码](images/uniapp_picture_4.png)

**5.开启服务端口**

![开启服务端口](images/uniapp_picture_5.png)

**小技巧分享：模拟器窗口分离和置顶**

![模拟器窗口分离和置顶](images/uniapp_picture_6.png)

**Hbuildex 和 微信开发者工具 关系**

![Hbuildex 和 微信开发者工具 关系](images/uniapp_picture_7.png)
...
![VS Code 和 微信开发者工具 关系](images/uniapp_picture_8.png)

**HbuilderX 和 微信开发者工具 关系**
![HbuilderX 和 微信开发者工具 关系](images/uniapp_picture_7.png)
